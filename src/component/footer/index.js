...
import { faAddressBook, faAlignJustify, faHome, faMoneyBill, faUser, faUsers } from '@fortawesome/free-solid-svg-icons';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.section} >
                <TouchableOpacity style={styles.icon} onPress={() => props.navigation.navigate('Akademic')}>
                    <FontAwesomeIcon icon={faAlignJustify} style={{color:'#163F5F'}} size={ 27 }  color = {props.focus === 'Akademic' ? '#54B3B9' : ''} />
                    <Text style={styles.text} >Pelajaran</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.section} >
