        ...
        <ScrollView>        
            <View style={{flexDirection:'row',}}>
                <View style={{flex:1.5, backgroundColor:'#1774BC',height:700}}>                       
                    ...
                    <Text style={styles.textTitle}>Usia Minimal</Text>
                    <Text style={styles.textTitle}>Usia Maksimal</Text>
                </View>
                <View style={{flex:2, backgroundColor:'#E5E7E9'}}>
                    ...
                    <View style={{top:40}}>
                        <View style={{padding:5}}>
                            <Text style={{color:'#696969',fontSize:27,fontWeight:'bold'}}>Kelompok Umur</Text>
                        </View>
                        <Text style={styles.textTitleRight}>{grade.name}</Text>
                        <Text style={styles.textTitleRight}>{grade.agemin} Tahun</Text>
                        <Text style={styles.textTitleRight}>{grade.agemax} Tahun</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
